...
export function getInputPlaceholder(key: string): string {
  ...
  if (normalized.includes("active b12")) return "50"
  if (normalized.includes("hs-crp")) return "1.2"
  if (normalized.includes("crp")) return "2.1"
  if (normalized.includes("testosterone")) return "620"
  if (normalized.includes("free testosterone")) return "120"
  ...
  if (normalized.includes("free t4")) return "1.2"
  if (normalized.includes("free t3")) return "3.4"
  if (normalized.includes("tpo")) return "10"
  if (normalized.includes("non-hdl")) return "110"
  ...
  if (normalized.includes("egfr")) return "95"
  if (normalized.includes("bun")) return "12"
  if (normalized.includes("albumin")) return "4.2"
  if (normalized.includes("ggt")) return "22"
  if (normalized.includes("uric")) return "5.2"
  if (normalized.includes("homocysteine")) return "8"
  if (normalized.includes("pth")) return "35"
  if (normalized.includes("lh")) return "5"
  if (normalized.includes("fsh")) return "6"
  if (normalized.includes("prolactin")) return "10"
  if (normalized.includes("dhea")) return "280"
  if (normalized.includes("psa")) return "1.2"
  if (normalized.includes("progesterone")) return "0.5"
  if (normalized.includes("zinc")) return "95"
  if (normalized.includes("selenium")) return "130"
  if (normalized.includes("iodine")) return "150"
  if (normalized.includes("omega-3") || normalized.includes("omega 3")) return "6.5"
  if (normalized.includes("mma")) return "0.18"
  if (normalized.includes("rbc folate")) return "500"
  if (normalized.includes("fibrinogen")) return "300"
  if (normalized.includes("c-peptide")) return "1.8"
  if (normalized.includes("coq10")) return "1.0"
  if (normalized.includes("stfr")) return "3.5"
