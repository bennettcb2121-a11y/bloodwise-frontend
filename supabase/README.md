...
After that, sign up and log in from the Clarion Labs UI (email or Google/GitHub); profile and bloodwork data save and load automatically. For full website + Stripe subscription setup, see **[SETUP.md](../SETUP.md)**.
